...
public class MetricsLogger {
    ...
    private static final Logger plainsourcelogger                   = LoggerFactory.getLogger("metrics.source.plain");
    
    private static final Logger plainsinklogger                   = LoggerFactory.getLogger("metrics.sink.plain");
    
    private static final Logger jsonsourcelogger                   = LoggerFactory.getLogger("metrics.source.json");
    
    private static final Logger jsonsinklogger                   = LoggerFactory.getLogger("metrics.sink.json");
