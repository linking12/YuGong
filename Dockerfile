...
RUN mkdir /root/pinpoint-agent-1.6.1-SNAPSHOT \
    && curl -o /root/pinpoint-agent-1.6.1-SNAPSHOT/pinpoint-agent-1.6.1-SNAPSHOT.zip --user 'admin:123' http://repo.quancheng-ec.com/repository/documentation/pinpoint-agent-1.6.1-SNAPSHOT.zip \
